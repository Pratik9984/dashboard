...
export default function ClientsPage() {
  ...
  const columns = useMemo<Column<Client>[]>(() => [
    ...
    { key: "actions", label: "", render: (c) => (
      <div className="flex items-center gap-1">
        {c.website && <a href={c.website} target="_blank" className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-400 hover:text-blue-500"><Globe className="w-3.5 h-3.5" /></a>}
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <DataTable columns={columns} data={filtered as unknown as Record<string, unknown>[]} searchKeys={["name", "company", "email", "industry"]} searchPlaceholder="Search clients..."
